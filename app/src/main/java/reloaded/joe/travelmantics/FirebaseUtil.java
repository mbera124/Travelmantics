...
public class FirebaseUtil {
    ...
    @SuppressLint("StaticFieldLeak")
    private static reloaded.joe.travelmantics.List caller;

    private FirebaseUtil(){}
    public static boolean isAdmin;

    public static void openFbReference(String ref, final reloaded.joe.travelmantics.List callerActivity){
